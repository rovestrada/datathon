...
| `segment_summary.pkl` | 6 x 9 | Resumen de segmentos descubiertos por clustering. |
...
| `cluster_visualization.html` | HTML interactivo | Visualizacion PCA de clusters, tamano de segmentos y perfil relativo por segmento. |
